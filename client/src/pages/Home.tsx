...
export default function Home() {
  ...
  return (
    <div className="bg-gradient min-h-screen font-sans text-light overflow-hidden">
      ...
      {/* Developer Credit and Instagram Link */}
      <footer className="fixed bottom-20 right-4 z-10">
        <motion.div 
        ...
        >
          <a 
            ...
            className="text-light-dimmed hover:text-primary text-sm flex items-center mb-1 transition-colors"
          >
            <span className="mr-1">Follow me on Instagram</span>
          ...
          <p className="text-light-dimmed text-xs">Developed by Shasikiran_2004</p>
        </motion.div>
      </footer>
